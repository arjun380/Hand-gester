//https://teachablemachine.withgoogle.com/models/vfMQjoqzn/
...
console.log('ml5 verson'+ ml5.version)
    ...
    classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/vfMQjoqzn/modle.json',modelLoaded);
